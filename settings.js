...
module.exports = {
SESSION_ID: process.env.VAJIRA-MD=eJVw3bQC#QiqNDotzxgaIAOMA36lqWXsjAdFdOzjV-3dYDJYUVCs 
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '' : process.env.94719735716,   
